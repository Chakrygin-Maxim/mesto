class Card {
    ...
    constructor(item, userId, templateSelector, openPopupPhotoHandler, openPopupDeleteConfirmHandler, handleButtonLikeClick) {
    ...
    _handleButtonLike(evt) {
        this._handleButtonLikeClick(evt, this._cardId)
            .then(data => {
